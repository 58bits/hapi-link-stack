...
exports.register = function (server, options, next) {
  ...
  // NOTE: For some reason the cache object doesn't survive, Hoek.applyToDefaults
  // So we're simply setting the settings here.
  var settings = {
  ...
  server.decorate('request', 'linkStack', linkStack);
